...
// operations on accounts. It is also necessary to the use of go-kit
...
// NewService is necessary because we need the ability to create a sqlDBTx stuct from withing the main func
